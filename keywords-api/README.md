...
Extract keywords associated with a domain.
...
Returns keyword data associated with the specified domain.
...
| `LOOKUP` | Domain to extract keywords for (default: `builtwith.com`) |

## API Reference

- **Endpoint**: `https://api.builtwith.com/kw2/api.json`
- **Method**: GET
