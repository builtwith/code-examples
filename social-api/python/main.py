...
lookup = os.getenv("LOOKUP", "twitter.com/builtwith")
...
print("BuiltWith Social API")
print(f"Looking up: {lookup}")
print("---")

response = requests.get("https://api.builtwith.com/social1/api.json", params={"KEY": api_key, "LOOKUP": lookup})
