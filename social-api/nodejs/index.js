...
const lookup = process.env.LOOKUP || 'twitter.com/builtwith';
...
const url = `https://api.builtwith.com/social1/api.json?${params.toString()}`;

console.log('BuiltWith Social API');
