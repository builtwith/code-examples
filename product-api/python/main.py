...
query = os.getenv("QUERY", "headphones")
...
print("BuiltWith Product API")
print(f"Query: {query}")
print("---")

response = requests.get("https://api.builtwith.com/productv1/api.json", params={"KEY": api_key, "QUERY": query})
