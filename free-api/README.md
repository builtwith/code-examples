...
Get summary counts and updates for technology groups on a domain.
...
Returns summary category counts and group-level technology data for the specified domain.
